...
Product product1 = {
    id: 1,
    name: "24' HD Ready LED TV",
    description: "24 inches HD LED Television with 3year Warranty",
    price: "$320.00"
};
Product product2 = {id: 2, name: "ABC 5 in 1 Juice Blender", description: "5 in 1 Juice Blender", price: "$20.54"};
Product product3 = {
    id: 3,
    name: "Women V Neck Blue Tshirt",
    description: "High quality Cotton V Neck Blue Tshirt",
    price: "$39.37"
};
Product product4 = {
    id: 4,
    name: "XYZ Aloe Vera Herbal Hair Conditioner",
    description: "XYZ Aloe Vera Rinse-Off Herbal"
+ " Hair Conditioner 200ml",
    price: "$11.00"
};
Product product5 = {
    id: 5,
    name: "Multifunctional Storage Wardrobe",
    description: "Multifunctional Wooden Storage Wardrobe",
    price: "$49.61"
};

map<Product> productList = {"1": product1, "2": product2, "3": product3, "4": product4, "5": product5};

listener http:Listener samplestore = new(9090);

# Description.
service /samplestore on samplestore {
